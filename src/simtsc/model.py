...
class SimTSCTrainer:
    ...
    def fit(self, model, X, y, train_idx, distances, K, alpha, test_idx=None, report_test=True, batch_size=128, epochs=500):
        self.K = K
        self.alpha = alpha
        ...
        for epoch in range(epochs):
            ...
            for sampled_train_idx in train_loader:
                ...
                sampled_train_idx = np.array(sampled_train_idx) # modify to numpy array to avoid error
            ...
            if report_test and (epoch+1) % 100 == 0:
